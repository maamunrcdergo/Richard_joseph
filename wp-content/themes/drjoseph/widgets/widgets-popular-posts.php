...
class Populer_Post_Widget extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'master_uiu_tabbed_widget', 'description' => __('Displays tabbed list of popular posts, recent posts & comments', 'uiu') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'master_uiu_tabbed_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'master_uiu_tabbed_widget', __('Master UIU Popular Posts Widget', 'uiu'), $widget_ops, $control_ops );
	}
        ...
        <div class="widget tabbed">
            <div class="tabs-wrapper">
                <ul class="nav nav-tabs">
                      <li class="active"><a href="#popular-posts" data-toggle="tab"><?php esc_attr_e( 'Popular', 'uiu' ); ?></a></li>
                      <li><a href="#recent" data-toggle="tab"><?php esc_attr_e( 'Recent', 'uiu' ); ?></a></li>
            ...
            <div class="tab-content">
                ...
                <?php foreach($recent_comments as $comment) : ?>
                    ...
                    <li>
                        <div class="content">
                            <?php if ( $comment->comment_author ) { echo $comment->comment_author; } else { _e('Anonymous','uiu'); } ?> <?php _e('on','uiu'); ?>
	...
	function form( $instance ) {
		...
		<!-- Number of posts -->
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e('Number of posts to show','uiu') ?>:</label>
