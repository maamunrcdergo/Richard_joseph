...
class Testimonials_Content_Type {
  ...
  private $post_type = 'drjosefh_testimonial';
  ...
  public function register() {
    ...
    $service_arg = array(
      ...
      'menu_icon' => DRJOSEPH_THEME_URL . '/images/icon-testimonial.png'
    );
...
function get_drjosefh_testimonials($args = array()) {
  $defaults = array(
    'post_type' => 'drjosefh_testimonial',
