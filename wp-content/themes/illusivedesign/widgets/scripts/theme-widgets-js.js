...
nc(document).ready(function () {
    ...
    nc(".add_field_button").live('click',function () { //on add input button click
//         console.log('click');
         var button = nc(this);
          var $parent = button.parents('.widget-content');
         var repeater = $parent.find('.repeater').eq(0).clone();
         nc('input,select',repeater).val('');
        
         repeater.appendTo($parent.find('.additional'));
    });
